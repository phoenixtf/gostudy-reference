# Описание процесса оплат сайта gostydy.cz (bydleni-pro-studenty.cz, startsale.cz)
...
## Принцип запуска проета и работа с разными хостами
...
### Формирование списка объектов для оплаты - Фронтенд
